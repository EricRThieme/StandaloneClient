...
internal class STTItemConverter {
    ...
    private fun appendDateTime(b: StringBuilder, dt: LocalDateTime) {
        ...
        val mi = dt.minute
        val s = dt.second
        b.append((y / 1000 % 10 + '0'.code).toChar())
        b.append((y / 100 % 10 + '0'.code).toChar())
        b.append((y / 10 % 10 + '0'.code).toChar())
        b.append((y % 10 + '0'.code).toChar())
        b.append('-')
        b.append((mo / 10 % 10 + '0'.code).toChar())
        b.append((mo % 10 + '0'.code).toChar())
        b.append('-')
        b.append((d / 10 % 10 + '0'.code).toChar())
        b.append((d % 10 + '0'.code).toChar())
        b.append('_')
        b.append((h / 10 % 10 + '0'.code).toChar())
        b.append((h % 10 + '0'.code).toChar())
        b.append(':')
        b.append((mi / 10 % 10 + '0'.code).toChar())
        b.append((mi % 10 + '0'.code).toChar())
        b.append(':')
        b.append((s / 10 % 10 + '0'.code).toChar())
        b.append((s % 10 + '0'.code).toChar())
    }
}
